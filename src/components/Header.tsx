            ...
            <Container maxWidth="xl">
                ...
                <Menu
                    ...
                    {setNavLinks.map((navLink) => (
                        <MenuItem key={navLink.text} onClick={handleCloseNavMenu} component={Link} to={navLink.url}>
                        <Typography textAlign="center">{navLink.text}</Typography>
                        </MenuItem>
                    ))}
                    </Menu>
                </Box>
